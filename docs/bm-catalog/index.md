...
| [소모성 재화 (컨슈머블)](consumable.md) | 뼈대 | 사용하면 사라지는 부스터/재화형 아이템 |
...
| [구독형](subscription.md) | 뼈대 | 정기 결제로 지속적 혜택을 제공 |

## 소유·꾸미기 계열

| 항목 | 상태 | 한줄 정의 |
|---|---|---|
| [코스메틱](cosmetic.md) | 뼈대 | 밸런스에 영향 없는 외형/장식 판매 |
| [VIP / 멤버십](vip-membership.md) | 뼈대 | 등급별 지속 혜택 패키지 |

## 콘텐츠 확장 계열

| 항목 | 상태 | 한줄 정의 |
|---|---|---|
| [DLC / 에피소드 판매](dlc.md) | 뼈대 | 완성된 콘텐츠 단위를 개별 판매 |

## 비결제 계열

| 항목 | 상태 | 한줄 정의 |
|---|---|---|
| [광고형 (리워드형)](ad-based.md) | 뼈대 | 광고 시청을 재화/보상과 교환 |
